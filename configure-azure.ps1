...
az staticwebapp appsettings set `
  ...
  --setting-names `
    ...
    "WHATSAPP_ACCESS_TOKEN=EAATvUFLSAkBPZCUNaGkzZBPJ41tY0eHJ1gZBRfO8n4AIOXsMatzrRoi3ZCJXwwlfhr8es2ylOE8WDwht3e8kIIAt80mmbSBYU8A7cEgQz90FYhqrWS4mbZCV3GyDTuDbzYe5TgR2YZCVLsnJ05A7mYZBrknVOaFaOKkveK6SQI8ZBU43ZBxnL1rFg3bQ9IVEfulHPXWr7hzMUnYZD" `
    "WHATSAPP_PHONE_ID=810368655501760" `
